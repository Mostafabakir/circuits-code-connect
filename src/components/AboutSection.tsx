            ...
            <CardContent className="p-0">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  I'm a versatile embedded systems engineer with over 8 years of experience bridging the gap between hardware and software. My journey began with electrical engineering and circuit design, evolving to encompass firmware development, IoT solutions, and full-stack web applications.
                </p>
        ...
        <div className="space-y-6">
          <Card className="card-hover">
            <CardContent className="p-6">
              ...
              <p className="text-gray-700">MSc in Electrical & Computer Engineering</p>
              <p className="text-gray-500 text-sm">Technical University, 2014-2016</p>
            </CardContent>
          </Card>
          ...
          <Card className="card-hover">
            <CardContent className="p-6">
              ...
              <p className="text-gray-700">Lead Embedded Systems Engineer</p>
              <p className="text-gray-500 text-sm">IoT Solutions Inc., 2018-Present</p>
            </CardContent>
          </Card>
